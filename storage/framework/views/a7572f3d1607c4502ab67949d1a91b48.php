    ...
    <div class="container hero-grid">
        <div>
            ...
            <div class="hero-actions">
                ...
                <a class="btn btn-light" href="<?php echo e(route('admin.login')); ?>">Masuk sebagai Pakar</a>
            </div>
        </div>
        <div class="hero-card diagnosis-preview">
            <div class="metric">
                <span>Basis Gejala</span>
                <strong><?php echo e($jumlahGejala); ?></strong>
            </div>
            <div class="metric">
                <span>Jenis Kerusakan</span>
                <strong><?php echo e($jumlahKerusakan); ?></strong>
            </div>
            <div class="metric">
                <span>Rule Pakar</span>
                <strong><?php echo e($jumlahRule); ?></strong>
            </div>
            <div>
...
<section class="section" style="padding-top:0;padding-bottom:0">
    <div class="container" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px">
        ...
        <div class="stat-card" data-animate="zoom-in" data-delay="550">
            ...
            <strong><?php echo e($jumlahKonsultasi); ?></strong>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="cta-banner" data-animate="zoom-in">
            ...
            <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;position:relative;z-index:1">
                <a class="btn btn-light" href="<?php echo e(route('consultation.create')); ?>" style="font-size:16px;padding:14px 28px">
                    Mulai Konsultasi →
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dedsec/Sistem_Pakar_Kerusakan_Laptop/resources/views/home.blade.php ENDPATH**/ ?>